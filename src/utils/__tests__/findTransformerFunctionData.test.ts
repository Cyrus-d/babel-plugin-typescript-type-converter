...
import { findTransformerFunction } from '../findTransformerFunction';

describe('findTransformerFunctionData', () => {
  test('should find function info with single type argument', () => {
    ...
    const functionInfos = findTransformerFunction(sourceFile, ['transform']);
